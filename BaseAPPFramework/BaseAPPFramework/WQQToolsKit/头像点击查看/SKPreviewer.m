...
- (void)previewFromImageView:(UIImageView *)imageView container:(UIView *)container
{
    ...
    self.containerView.wq_origin = CGPointZero;
    ...
    self.scrollView.contentSize = CGSizeMake(self.height, MAX(self.containerView.height,self.height));
...
//    放大点击区域
    if (self.scrollView.zoomScale > 1.0) {
        ...
        CGFloat x = self.width / newZoomScale;
        CGFloat y = self.height / newZoomScale;
